...
<rapid:override name="left">
    <div id="primary" class="content-area">
        ...
        <%@ include file="WEB-INF/view/Home/Public/part/paging.jsp" %>
...
<rapid:override name="right">
    <%@include file="WEB-INF/view/Home/Public/part/sidebar-2.jsp" %>
</rapid:override>
<%--侧边栏 end--%>
...
<%@ include file="WEB-INF/view/Home/Public/framework.jsp" %>